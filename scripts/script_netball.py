...
# Filtrer uniquement les sites où sport=netball (y compris s'il y a plusieurs sports, ex: "netball;basketball")
df = df[df["sport"].str.contains("netball", na=False, case=False)]
...
print(f"\n✅ Nombre total de sites pour netball : {len(df)}")
print(df.head())

# Créer une carte centrée sur l'Afrique
m = folium.Map(location=[0, 25], zoom_start=3)

# Ajouter un point pour chaque site de netball
...
m.save("netball_map.html")
print("\n✅ Carte générée : ouvre 'netball_map.html' dans un navigateur.")
